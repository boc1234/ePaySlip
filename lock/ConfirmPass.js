      ...
      for(var i = 0 ;i< tempCode.length;i++){
          if(tempCode[i] == ''){
              ...
              if(pin.length == 6){
                ...
                if(this.props.route.params?.pin == pin){
    ...
    return (
        ...
        <View style={styles.swipe}>
            ...
            <View style={{marginTop:50}}>
                <View >
                    <Text style={styles.passcodeText}>Confirm Password</Text>
        ...
        <View style={styles.buttons}>
            <TouchableOpacity  >
                ...
                <Text style={styles.buttonText} onPress={() => navigation.navigate('CreatePass')} >Back</Text>
            </TouchableOpacity>
