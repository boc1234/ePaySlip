...
const OpenURLButton = ({ url, children }) => {
  ...
  return <Button title={children} onPress={handlePress} />;
    ...
    const signUp =()=>{
        ...
        formData.append('idcardnum','2')
        formData.append('passportidnum',passport)
        formData.append('pin',md5(pin))
        formData.append('phonenum','2')
        formData.append('ownerphone',status)
        ...
        // axios.post('http://localhost:8080/AddUser?data=' +postData,{
            
        //      headers: { "Content-Type": "application/json; "
        //            },})

        // .then(function (response) {
        //     console.log(response.data.bool_Result);
        //     if(response.data.bool_Result == true){
        //         navigation.navigate("SignIn");
        //     }else{
        //         alert(response.data.string_Message)
        //     }
        ...
        //     headers: {"Content-Type": "application/json; "}
        //   });
        axios.post(URL+'AddUser', formData, {
            headers: {
        ...
        <View style={{padding: 24, flex: 1,}}>
            ...
            {/* <View  style={{flexDirection:'row',alignItems:'center'}}> */}
                ...
                <TouchableOpacity>
                    ...
                    {/* <AntDesign name="idcard" style={styles.icon} size={24}  /> */}
                    <TextInput style={styles.textInput} value={pin} editable={false} selectTextOnFocus={false} secureTextEntry={true}  ></TextInput>
                    </TouchableOpacity>

                <Text style={{paddingLeft:30}}>Scan*</Text>
                <TouchableOpacity>
                    {/* <AntDesign name="idcard" style={styles.icon} size={24}  /> */}
